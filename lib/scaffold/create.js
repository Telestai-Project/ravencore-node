...
var BASE_PACKAGE = {
  description: 'A full Telestau node build with Telecore',
  repository: 'https://github.com/telestai-project/telecore',
  license: 'MIT',
  readme: 'README.md',
  dependencies: {
    'ravencore-lib': 'git+https://github.com/telestai-project/telecore-lib.git',
    'ravencore-node': 'git+https://github.com/telestai-project/telecore-node.git'
  }
};
